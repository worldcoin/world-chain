...
The system is implemented as an upgradeable predeployed contract that owns the canonical subsidy state and exposes the claim, authorization, and view logic. A native revm extension performs per-transaction budget debits in-protocol by writing to a pinned subset of the contract’s storage slots.
