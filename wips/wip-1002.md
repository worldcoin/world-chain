...
```
claimAdditionalCredential(nullifier, 0x03, sessionNullifier2, sessionAction2, proof);
```
...
```
setAuthorized(nullifier, 0, [0xAlice], sessionNullifier3, sessionAction3, proof);
```
