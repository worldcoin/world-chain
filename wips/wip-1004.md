...
category: Core
created: 2026-05-14
requires: [RFC-8032](https://www.rfc-editor.org/rfc/rfc8032)
---
...
This precompile is intentionally not a [WIP-1001](./wip-1001.md) activation parameter. Its activation is defined by this WIP and the fork configuration that introduces it.
...
**Address `0x0100`.** Reserves a precompile slot above the Ethereum-reserved `0x01`–`0x0A` range and aligns with RIP-7212's convention of placing non-mainnet precompiles starting at `0x0100`. The concrete address MAY be revised by maintainers before activation.
