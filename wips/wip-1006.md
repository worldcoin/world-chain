...
4. The game snapshots the reserving account as `bondProposer`, independently of the factory caller, and records `createdAt`, `challengeDeadline`, and `proofDeadline`.
