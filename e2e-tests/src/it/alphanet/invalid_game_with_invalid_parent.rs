...
#[tokio::test]
#[ignore]
async fn submit_2_bad_consecutive_proposals() {
    // fetch env vars
    ...
    let registered_block_interval = alloy_proof_system_client
        ...
        .block_interval;
    let bad_root_claim = B256::with_last_byte(3);
    ...
    let first_proposal_submission = alloy_proof_system_client
        ...
        .await
        .unwrap();
    // create a child invalid game
    let bad_root_claim = B256::with_last_byte(4);
