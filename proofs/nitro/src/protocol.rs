...
pub fn range_user_data(boot_info: &TransitionPublicValues) -> [u8; 32] {
    ...
    hasher.update(boot_info.l1Head.as_slice());
    hasher.update(boot_info.l2PreRoot.as_slice());
    hasher.update(boot_info.l2PreBlockNumber.to_be_bytes());
    hasher.update(boot_info.l2PostRoot.as_slice());
    hasher.update(boot_info.l2PostBlockNumber.to_be_bytes());
...
pub fn signing_commitment(boot_info: &TransitionPublicValues) -> [u8; 32] {
    ...
    buf.extend_from_slice(&boot_info.l2PostBlockNumber.to_be_bytes());
