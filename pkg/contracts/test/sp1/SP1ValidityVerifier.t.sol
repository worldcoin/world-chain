...
contract SP1ValidityVerifierTest is Test {
    ...
    function _publicValues(ProofLib.TransitionPublicValues memory transition, bytes32 multiBlockVKey)
        internal
        pure
    ...
    function _expectSp1Call(ProofLib.TransitionPublicValues memory transition) internal {
    ...
    function test_Verify_FalseWhenProofAttestsDifferentTransition() public {
        ...
        ProofLib.TransitionPublicValues memory expected = _transition();
