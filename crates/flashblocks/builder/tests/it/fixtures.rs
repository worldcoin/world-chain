...
//
// The bulk of the fixture code lives in `flashblocks_builder::test_utils` so it
// can be shared with benchmarks.  Only proptest strategies remain here since
// `proptest` is not a dependency of the `bench` feature.

pub use flashblocks_builder::test_utils::*;
...
pub fn arb_execution_payload(
    ...
    Value = (
        flashblocks_primitives::primitives::ExecutionPayloadFlashblockDeltaV1,
        Option<
            flashblocks_builder::bal_executor::CommittedState<
