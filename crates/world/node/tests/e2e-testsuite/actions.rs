...
pub struct EthGetTransactionReceipt {
    ...
    pub tx: tokio::sync::mpsc::Sender<Vec<Option<alloy_consensus::Receipt>>>,
}
...
impl EthGetTransactionReceipt {
    ...
    pub fn new(
        ...
        node_idxs: Vec<usize>,
        backoff: u64,
        tx: tokio::sync::mpsc::Sender<Vec<Option<alloy_consensus::Receipt>>>,
    ) -> Self {
        Self {
            hash,
            node_idxs,
    ...
    fn execute<'a>(
        ...
        Box::pin(async move {
            ...
            for node_idx in &self.node_idxs {
                ...
                let receipt: Option<alloy_consensus::Receipt> =
                    EthApiClient::<
                        TransactionRequest,
                        Transaction,
                        alloy_rpc_types_eth::Block,
