...
use revm::{Database, DatabaseCommit, Inspector};
...
where
    ...
    <DB as revm::Database>::Error: std::fmt::Debug + Send + Sync + derive_more::with_trait::Error + 'static,
{
    let nonce = evm
        .db_mut()
