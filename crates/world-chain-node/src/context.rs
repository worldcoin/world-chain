...
pub struct WorldChainNetworkBuilder {
    ...
    world_chain_p2p_handle: Option<FlashblocksHandle>,
}
        ...
        + 'static,
{
    ...
    async fn build_network(
        ...
        if let Some(ref flashblocks_handle) = world_chain_p2p_handle {
        ...
        if world_chain_p2p_handle.is_some() {
